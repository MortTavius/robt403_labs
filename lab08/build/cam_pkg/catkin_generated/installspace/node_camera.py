...
def callback(data):
    ...
    if (coord_x < 330 and coord_x > 230 and coord_y < 330 and coord_y > 230):
        done = True
    if (done):
        cv2.rectangle(cv_image,(230,230),(330,330),(0,255,0),3)
    else:
        cv2.rectangle(cv_image,(230,230),(330,330),(0,0,255),3)
